  ...
  return (
    ...
    >
      ...
      <div className="lg:max-w-xl my-8 p-8">
        ...
        <p className="font-bold text-lg dark:text-slate-300 text-ebonyClay" style="max-width: 49rem;">
...
<br /> I am passionate about using technology to drive positive change and improve people&apos;s lives, and I am excited about the opportunity to contribute to innovative projects that have a real impact.

<br /> Feel free to explore my portfolio and connect with me on LinkedIn to learn more about my work and experience.
        </p>
      </div>
    </div>
  );
